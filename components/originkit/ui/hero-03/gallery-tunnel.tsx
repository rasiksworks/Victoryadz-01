...
export default function ImageBox(props: Partial<ImageBoxProps>) {
    ...
    useEffect(() => {
        ...
        const animate = (now: number) => {
            ...
            const extraBoost = pressed ? cfg.boost : (isMoving ? Math.min(cfg.boost * 0.25, moveSpeed) : 0);
            scrollPos += cfg.speed + extraBoost;
        ...
        const onMove = (e: PointerEvent) => {
            ...
            if (lastX !== 0 || lastY !== 0) {
                ...
                moveSpeed = Math.min(dist * 0.15, cfgRef.current.boost * 0.25);
            }
            lastX = e.clientX;
            lastY = e.clientY;
            isMoving = true;
