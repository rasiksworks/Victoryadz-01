...
export const BrandVisionSection: React.FC = () => {
  return (
    <section className="relative w-full bg-[#2C2C2C] text-white font-inter-display select-none">
      <div className="w-full px-6 md:px-[60px] lg:px-[60px]">
        
        {/* Top Header Row (Scrolls Up Past the Frame First, No Divider Line) */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 pt-16 pb-12">
          {/* Left Description */}
          <div className="flex flex-col justify-start">
            ...
            <ScrollHighlight className="text-xs md:text-sm leading-relaxed max-w-lg font-light block">
              Specializing in premium photo frames, we focus on craftsmanship that preserves your memories with the quality they deserve. Every frame is made with precision, using high-quality materials and lamination finishes that stand the test of time.
            </ScrollHighlight>
          </div>
        ...
        <div className="flex flex-col lg:flex-row items-start gap-6 relative">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-14 lg:gap-20 pt-6 pb-16">
            ...
            <div className="flex flex-col items-center gap-6 pt-2">
              <ImageReveal className="relative w-28 md:w-36 aspect-[3/4] overflow-hidden bg-[#222] border border-white/10 shadow-lg" duration={1.0}>
                <Image
                  ...
                  alt="Orange dress detail"
                  fill
                  sizes="144px"
                  className="object-cover object-center"
                />
              </ImageReveal>
              <button className="bg-white text-black px-7 py-3 text-xs tracking-[0.2em] uppercase font-semibold hover:bg-neutral-200 transition-colors shadow-xl flex items-center gap-1.5 cursor-pointer">
            ...
            {/* Bottom Pull Quote */}
            <div className="text-center max-w-md mx-auto pt-6 pb-12">
